...
void HighlightItem::start(const QPointF &point, const QPen &pen)
{
  grabMouse();
...
void HighlightItem::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void HighlightItem::mouseReleaseEvent(QGraphicsSceneMouseEvent *event)
{
...
QGraphicsItem *HighlightCreator::create(EditorScene *scene, const QPointF &point)
{
