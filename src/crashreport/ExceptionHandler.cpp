...
void initExceptionHandler()
{
  ...
  lstrcatW(fileName, L"-");
  lstrcpyW(fileName + lstrlenW(fileName), TEXT(VERSION_STRING));
  lstrcatW(fileName, L"-");
...
LONG WINAPI exceptionFilter(EXCEPTION_POINTERS *pExceptionInfo)
{
  ...
  lstrcatW(fileName, L"\\screenpic.exe");
  ShellExecuteW(NULL, L"open", fileName, L"-report", NULL, SW_SHOWNORMAL);
